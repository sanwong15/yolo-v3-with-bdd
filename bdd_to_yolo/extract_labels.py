...
json_data = open('/home/user/Desktop/bdd100k_data/bdd100k/labels/bdd100k_labels_images_train.json')
print("----- LOADING JSON -----")
...
for i in range(num_of_images):
    ...
    for j in range(num_of_object_in_image):
        ...
        # For some current_object_label that we need to avoid
        


        # Check if current_object_label is already in the dictionary
